    ...
    public void inputHandler() {
        ...
        while (isRunning) {
            ...
            try {
                ...
                setErrorMessage("!Invalid error detected. You got a ");
                System.out.println(getErrorMessage() + ex);
                LOGGER.log(Level.INFO, "{0}{1}", new Object[]{getErrorMessage(), ex});
                System.out.println("Please try again");
                scan = new Scanner(System.in, "UTF-8");
                try {
                    Thread.sleep(500);
                } catch (InterruptedException exc) {
                    LOGGER.log(Level.INFO, "{0}{1}", new Object[]{getErrorMessage(), exc});
                    isRunning = false;
                }
            }
        }
